<template>
  <v-app-bar
    ...
    app
  >
    <v-app-bar-nav-icon class="ms-2" @click="panel.toggle()"/>
...
<!--    />-->
    <v-spacer/>
    <v-btn class="mx-2" icon text @click="panel.fullScreen()">
    ...
    <v-menu :left="true" offset-y :nudge-bottom="5"
      ...
      <v-list class="pa-0">
        <v-list-item @click="panel.profile()">
          <v-list-item-action>
            <v-icon>mdi-account</v-icon>
          </v-list-item-action>
        ...
        <v-list-item @click="panel.logout()">
          <v-list-item-action>
    ...
    <v-menu :left="true" offset-y :nudge-bottom="5"
      ...
      <v-list class="pa-0">
        <v-list-item rel="noopener"
                     v-for="lang in panel.locales"
                     :key="lang.code"
                     :value="lang.code"
                     :input-value="(lang.code === panel.currentLocale)"
                     @click="panel.changeLocale(lang.code)"
        >
          <v-list-item-action>
