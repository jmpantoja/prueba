...
Feature:
  It is possible to create a director using the api
  As a api client
  ...
  Scenario:
    ...
    """
    When I request "POST" to "/directors"
    Then The response code is "201"
    And  The response body contains
    """
    {
      "@context": {
        "@vocab": "https://api.prueba.local/docs.jsonld#",
        "hydra": "http://www.w3.org/ns/hydra/core#",
        "id": "DirectorOutput/id",
        "name": "DirectorOutput/name",
        "movies": "DirectorOutput/movies"
      },
      "@type": "Director",
      "@id": "@regExp(#/directors/.*#i)",
      "id": "@regExp(/.*/i)",
      "name": {
        "name": "Francis",
        "lastName": "Ford Coppola"
